...
public class EnemyCapsuleScript : MonoBehaviour
{
    ...
    {
        hp = max_hp;
        bar_hp_max = Instantiate(bar_prefab, transform.position + Vector3.up, Quaternion.identity);
        bar_hp_cur = Instantiate(bar_prefab, transform.position + Vector3.up, Quaternion.identity);
